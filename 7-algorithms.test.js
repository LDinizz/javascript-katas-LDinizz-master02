...
describe('Função que recebe a temperatura em graus Farenheit e retorna em graus Celsius.', function() {
  ...
  it('212 fahrenheit é 100 celsius', function() {
...
describe('Função que leia 3 valores inteiros e exiba-os em ordem crescente', function() {
  function ordenar(val1, val2, val3) {
    var aux = [val1,val2,val3];
    return aux.sort(); // IMPLEMENTE
  }
...
describe('Função que recebe um vetor, e retorna quantas vogais foram encontradas em ordem', function() {
  ...
  it('retorna o array de vogais teste um', function() {
    expect(consoantes(['a', 'b', 'c'])).toEqual(['a']);
  });

  it('retorna um array vaziu se nenhuma vogal for encontrada', function() {
    expect(consoantes(['b', 'x'])).toEqual([]);
  });

  it('retorna o array de vogais teste três', function() {
    expect(consoantes(['a', 'e', 'i', 'x', 'o', 'u'])).toEqual(['a', 'e', 'i', 'o', 'u']);
  });

  it('retorna o array de vogais teste quatro', function() {
